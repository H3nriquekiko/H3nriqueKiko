        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InputType = table.Column<string>(type: "text", nullable: false, defaultValue: "Boolean")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilledByUserId = table.Column<string>(type: "text", nullable: true),
                    FilledAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChecklistRunItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChecklistRunItems_ChecklistItems_ItemId",
                        column: x => x.ItemId,
                        principalTable: "ChecklistItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChecklistRunItems_ChecklistRuns_RunId",
                        column: x => x.RunId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChecklistRunItems_ItemId",
                table: "ChecklistRunItems",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistRunItems_RunId_ItemId",
                table: "ChecklistRunItems",
                columns: new[] { "RunId", "ItemId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistRuns_ChecklistId_DateRef",
                table: "ChecklistRuns",
                columns: new[] { "ChecklistId", "DateRef" },
                unique: true);
        }
